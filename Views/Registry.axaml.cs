...
namespace MedEye.Views
{
    public partial class Registry : Window
    {
        ...
        private void AdaptToScreen()
        {
            ...
            Add.FontSize = 48 * (this.ClientSize.Width / 1920);
            Add.Height = 75 * (this.ClientSize.Width / 1920);
            Add.Width = 75 * (this.ClientSize.Width / 1920);
            AddMessage.FontSize = 32 * (this.ClientSize.Width / 1920);
        }
